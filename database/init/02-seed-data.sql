...
INSERT INTO songs (title, artist, album, duration, file_path, cover_url, artist_name, artist_nickname, nationality) VALUES 
    ('Getting Over', 'David Guetta', 'One Love', 333, 'http://localhost:5000/assets/track.mp3', 
     'https://jenesaispop.com/wp-content/uploads/2009/09/guetta_onelove.jpg', 
     'David Guetta', 'David Guetta', 'FR'),
    
    ('Snow Tha Product || BZRP Music Sessions #39', 'Snow', 'BZRP Music Sessions', 333, 'http://localhost:5000/assets/track-1.mp3',
    ...
    ('Calypso (Original Mix)', 'Round Table Knights', 'Round Table Knights', 333, 'http://localhost:5000/assets/track-2.mp3',
    ...
    ('Bad Habits', 'Ed Sheeran', 'Ed Sheeran', 333, 'http://localhost:5000/assets/track-4.mp3',
    ...
    ('BEBE (Official Video)', 'Giolì & Assia', 'Giolì & Assia', 333, 'http://localhost:5000/assets/track-3.mp3',
     'https://i.scdn.co/image/ab67616d0000b27345ca41b0d2352242c7c9d4bc',
     'Giolì & Assia', 'Giolì & Assia', 'IT'),
    
    ('T.N.T. (Live At River Plate, December 2009)', 'AC/DC', 'AC/DC', 333, 'http://localhost:5000/assets/track-5.mp3',
     'https://cdns-images.dzcdn.net/images/cover/ba5eaf2f3a49768164d0728b7ba64372/500x500.jpg',
     'AC/DC', 'AC/DC', 'US'),
    
    ('50 Cent - Candy Shop (feat. Olivia)', '50 Cent', '50 Cent', 333, 'http://localhost:5000/assets/track-6.mp3',
     'https://i.scdn.co/image/ab67616d0000b27391f7222996c531b981e7bb3d',
     '50 Cent', '50 Cent', 'US'),
    
    ('Bésame💋', 'Valentino', 'Valentino Ft MTZ Manuel Turizo (Video Oficial)', 333, 'http://localhost:5000/assets/track-7.mp3',
